...
absolute PR-AUC values here are higher than they would be at the capture's own prevalence (§11).
...
(ρ = +0.582); it is simply too coarse in the range where results are reported.
