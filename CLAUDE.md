...
**All 34 Python scripts are documented in [docs/scripts_reference.md](docs/scripts_reference.md)** — read it before assuming what a script does. Dependencies are pinned in `requirements.txt`.
...
│
├── scripts/                   ← 34 Python scripts + run_long.sh — see docs/scripts_reference.md
